	...
	function cn(e) {
		if (e >= ar)
			throw new RangeError(
				"Attempt to allocate Buffer larger than maximum size: 0x" + ar.toString(16) + " bytes",
			);
		return e | 0;
	}
	function Ca(e) {
...
var $ = (function () {
	...
	return function (n, i, o, s, a, l) {
		...
		if (!Y || !Y[0] || !V || !V[0])
			return new or(
				!n.s || !i.s || (Y ? V && Y[0] == V[0] : !V) ? NaN : (Y && Y[0] == 0) || !V ? nn * 0 : nn / 0,
			);
		for (
		...
		_request(n) {
			...
			let i = n.middlewareArgsMapper ?? Tp,
				...
				l = async (f) => {
					...
					if (g)
						return this._tracingHelper.runInChildSpan(s.middleware, (M) => g(f, (_) => (M?.end(), l(_))));
