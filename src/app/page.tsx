...
export default function Portfolio() {
  return (
    <div className="min-h-screen bg-linear-to-b from-zinc-900 via-zinc-900 to-black text-white overflow-hidden">
      <MouseFollower />
      <ScrollProgress />
      <FloatingNav />
        ...
        <div className="container relative z-10">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center mt-16">
            <div className="relative">
              <div className="absolute -inset-4 rounded-xl bg-linear-to-r from-purple-500/20 to-pink-500/20 blur-xl opacity-70"></div>
            ...
            <div className="space-y-6">
              <GlassmorphicCard>
                <p className="text-lg text-zinc-300">
                  ...
                  comfortable working with backend technologies like Node.js and
                  NestJS.
                </p>
                <p className="text-lg text-zinc-300 mt-4">
                  My journey in tech started with a strong foundation in
                  software development. I&apos;ve worked with enthusiams friends to
