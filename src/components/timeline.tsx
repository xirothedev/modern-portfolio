      ...
      {experiences.map((experience, index) => (
        ...
        >
          <motion.div
            ...
            viewport={{ once: true }}
          >
            <div className="relative overflow-hidden rounded-xl bg-zinc-800/50 backdrop-blur-xs border border-zinc-700/50 p-6 transition-all duration-300 hover:border-purple-500/50">
              <div className="absolute -inset-1 bg-linear-to-r from-purple-500/10 to-pink-500/10 rounded-xl blur-sm opacity-25 hover:opacity-100 transition duration-1000 hover:duration-200"></div>
          ...
          {!isMobile && (
            <div className="absolute left-1/2 -translate-x-1/2 flex items-center justify-center">
              <motion.div
                className="w-6 h-6 rounded-full bg-linear-to-r from-purple-500 to-pink-500 z-10 flex items-center justify-center"
                initial={{ scale: 0 }}
                whileInView={{ scale: 1 }}
